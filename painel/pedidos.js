...
function carregarPedidos() {
  ...
  unsubscribePedidos = query.onSnapshot(function (snap) {
    ...
    atualizarBadgePendentes();
    console.error('[Painel Pedidos] Falha ao escutar pedidos do Firestore.', error);
...
async function excluirMesa(id, numero) {
  ...
  if (!await EU.confirmar('Excluir a Mesa ' + numero + '? Essa ação não pode ser desfeita.')) return;
