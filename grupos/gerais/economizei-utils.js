/* ==============================================================
   ...
   Extraído de: Onde Comer, Vagas, Festas, Trilhas, Ônibus, Vitrine
...
(function (global) {
    ...
    // Garante que um link vindo de planilha só usa protocolo http/https
    // antes de virar href (evita esquemas perigosos como javascript:).
    ...
    // ---------- PARSER CSV (aspas, vírgulas e quebras de linha dentro de campo) ----------
    ...
    // ---------- CACHE DE CSV NO LOCALSTORAGE (com fallback seguro) ----------
    // criarCacheCSV('minhaChave', 3600000) -> { ler(), salvar(linhas) }
    ...
    // criarGerenciadorFavoritos('ondeComerFavoritos') -> { getTodos(), toggle(id), tem(id) }
    ...
    // ---------- QR CODE (mesmo padrão usado em Onde Comer / Festas / Vitrine) ----------
    ...
    // ---------- MODAL ACESSÍVEL (foco preso, Esc fecha, foco devolvido) ----------
    // const modal = criarModalAcessivel();
    // modal.abrir(elementoModal); ... modal.fechar();
