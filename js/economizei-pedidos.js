...
Economizei.Pedido = (function() {
    ...
    (function() {
        ...
        style.textContent = '#semTrocoCheckbox{appearance:none!important;-webkit-appearance:none!important;width:1.05rem!important;height:1.05rem!important;min-width:1.05rem!important;margin:0!important;border:2px solid #94a3b8!important;border-radius:.25rem!important;background:#fff!important;display:inline-grid!important;place-content:center!important;cursor:pointer!important;vertical-align:middle!important}#semTrocoCheckbox:checked{background:#0a66c2!important;border-color:#0a66c2!important}#semTrocoCheckbox:checked::after{content:"✓";color:#fff;font-size:.72rem;font-weight:800;line-height:1}#semTrocoCheckbox:focus-visible{outline:3px solid rgba(10,102,194,.28);outline-offset:2px}.btn-tamanho-modal:active,.extra-qtd button:active,.qtd-btn-simples:active,.btn-pedido-cta:active{transform:scale(.97)}.btn-tamanho-modal.ativo,.btn-selecionar-sabor.selecionado{box-shadow:0 0 0 3px rgba(10,102,194,.16)}.modal-extras-pontual{width:min(94vw,960px)!important;max-width:none!important;max-height:90vh!important;overflow:hidden!important}.modal-extras-pontual .modal-body{overflow-y:auto!important;min-height:0}.modal-extras-pontual #extrasContainerModal,.modal-extras-pontual #extrasSimplesContainer{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:.75rem}.produtos-grid{grid-template-columns:repeat(auto-fit,minmax(180px,1fr))!important;align-items:stretch}.modal-extras-pontual .modal-footer,.modal-customizacao-full .modal-footer,#modalPedidoRest .modal-footer,.popup-confirmacao-footer{padding-bottom:max(.75rem,var(--reserva-barra-app,0px),env(safe-area-inset-bottom))!important}.modal-imagem-full .lado-direito{display:grid!important;grid-template-columns:minmax(2rem,auto) minmax(3rem,5rem) minmax(2rem,auto) minmax(150px,1fr)!important;align-content:start!important;align-items:center!important;justify-content:stretch!important;gap:.75rem!important;overflow-y:auto!important;padding-bottom:max(1rem,var(--reserva-barra-app,0px),env(safe-area-inset-bottom))!important}.modal-imagem-full .lado-direito>.produto-nome,.modal-imagem-full .lado-direito>.tamanho-botoes-modal,.modal-imagem-full .lado-direito>.preco,.modal-imagem-full .lado-direito>.descricao{grid-column:1/-1}.modal-imagem-full .lado-direito>.produto-quantidade-simples{grid-column:1/4;justify-content:flex-start!important;margin:0!important}.modal-imagem-full .lado-direito>#addImagem{grid-column:4;width:100%!important;margin:0!important}.modal-header .btn-modal-fechar::before{content:"\\00D7"!important}.popup-confirmacao-header .popup-confirmacao-close{position:static;background:rgba(255,255,255,.18);border-color:rgba(255,255,255,.55);color:#fff}.popup-confirmacao-header .popup-confirmacao-close:hover{background:rgba(255,255,255,.3);color:#fff}@media(max-width:700px){.modal-extras-pontual{width:calc(100vw - 1rem)!important;max-height:calc(100dvh - 1rem)!important}.modal-extras-pontual .modal-body{padding:.75rem!important}.modal-extras-pontual #extrasContainerModal,.modal-extras-pontual #extrasSimplesContainer,.produtos-grid{grid-template-columns:1fr}.modal-imagem-full .container-imagem{flex-direction:column!important;align-items:stretch!important}.modal-imagem-full .lado-esquerdo{height:46vh!important;min-height:180px!important;flex:0 0 46vh!important;padding:.5rem!important}.modal-imagem-full .lado-direito{display:flex!important;flex-direction:column!important;min-width:0!important;width:100%!important;height:auto!important;flex:1 1 auto!important;gap:.5rem!important;padding:.75rem!important}.modal-imagem-full .lado-direito>.produto-quantidade-simples{width:100%;justify-content:center!important}.modal-imagem-full .lado-direito>#addImagem{width:100%!important;margin-top:.25rem!important}}';
