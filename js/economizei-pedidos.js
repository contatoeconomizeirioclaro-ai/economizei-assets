...
Economizei.Pedido = (function() {
    ...
    function atualizarStatusLojaUI(statusLoja, statusMessage) {
        ...
        if (msgDiv) {
            ...
            else if (statusMessage && String(statusMessage).trim()) { msgDiv.style.display = 'block'; msgDiv.innerHTML = '🟢 Aviso da loja: ' + Core.sanitize(statusMessage); msgDiv.setAttribute('role', 'status'); } else { msgDiv.style.display = 'none'; }
        }
